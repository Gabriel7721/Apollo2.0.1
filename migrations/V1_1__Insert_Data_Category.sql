...
IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Electronic' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Electronic', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Computers' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Computers', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Smart Homes' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Smart Homes', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Arts & Craft' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Arts & Craft', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Automotive' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Automotive', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Baby' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Baby', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Beauty and Personal Care' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Beauty and Personal Care', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Women''s Fashion' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Women''s Fashion', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Men''s Fashion' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Men''s Fashion', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Girl''s Fashion' AND parent_Category_Id = 1)
BEGIN
    INSERT INTO category (attribute, parent_Category_Id) VALUES ('Girl''s Fashion', 1);
END

IF NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Boy''s Fashion' AND parent_Category_Id = 1)
BEGIN
...
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Health and Household' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Home and Kitchen', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Home and Kitchen' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Industrial and Scientific', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Industrial and Scientific' AND parent_Category_Id = 1);

-- Continue the same pattern for the remaining statements

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Luggage', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Luggage' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Movies & Television', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Movies & Television' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Pet supplies', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Pet supplies' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Software', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Software' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Sport and outdoors', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Sport and outdoors' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Tool & Home Improvement', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Tool & Home Improvement' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Toys and Games', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Toys and Games' AND parent_Category_Id = 1);

INSERT INTO category (attribute,parent_Category_Id)
SELECT 'Video Games', 1
WHERE NOT EXISTS (SELECT 1 FROM category WHERE attribute = 'Video Games' AND parent_Category_Id = 1);
